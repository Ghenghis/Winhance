...
namespace Winhance.Core.Features.FileManager.Interfaces
{
    ...
    public interface ISpaceAnalyzerService
    {
        ...
        /// </summary>
        Task<IEnumerable<FileTypeSpaceInfo>> GetSpaceByFileTypeAsync(string path,
            CancellationToken ct = default);

        /// <summary>
        /// Get space usage by age (old files).
        /// </summary>
        Task<IEnumerable<AgeGroupSpaceInfo>> GetSpaceByAgeAsync(string path,
            CancellationToken ct = default);
        ...
        /// </summary>
        Task<CleanupSuggestions> GetCleanupSuggestionsAsync(string? path = null,
            CancellationToken ct = default);
    }
